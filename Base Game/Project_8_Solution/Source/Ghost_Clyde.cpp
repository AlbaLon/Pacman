...
void Enemy_Clyde::Update()
{
	...
	switch (currentMode)
	{
	case Enemy_Clyde::CHASE:
		break;
	case Enemy_Clyde::SCATTER:
		break;
	case Enemy_Clyde::FEAR:
