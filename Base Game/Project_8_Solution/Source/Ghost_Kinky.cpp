...
void Enemy_Kinky::Update()
{
	...
	switch (currentMode)
	{
	case Enemy_Kinky::CHASE:
		break;
	case Enemy_Kinky::SCATTER:
		break;
	case Enemy_Kinky::FEAR:
