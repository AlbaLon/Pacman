...
public:
	...
	int TileSet[29][38] = {
	 ...
	 WALL  ,WALL,  WALL, EMPTY,EMPTY,WALL, EMPTY,EMPTY,WALL, WALL, WALL, WALL, EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,WALL, WALL, WALL, WALL, EMPTY,EMPTY,WALL, EMPTY,EMPTY,EMPTY,EMPTY,WALL ,	//6
	 ...
	 WALL  ,EMPTY, EMPTY,EMPTY,WALL, WALL, EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,WALL, EMPTY,EMPTY,WALL, EMPTY,EMPTY,WALL, EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,WALL, WALL, WALL, EMPTY,EMPTY,WALL ,	//8
