...
public:
	...
	EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,	//5 *
	EMPTY,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,EMPTY, //6 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,	//7 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,	//8 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL,EMPTY ,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL ,EMPTY,	//9 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,	//10 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,	//11 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL,EMPTY ,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL ,EMPTY,	//12 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL,EMPTY ,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL ,EMPTY,	//13*
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,	//14 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,	//15 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL,EMPTY ,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL ,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,	//16 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL,EMPTY ,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL ,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,	//17 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,	//18 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY, EMPTY, EMPTY,EMPTY,EMPTY, WALL,EMPTY,	//19 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,EMPTY,WALL, WALL,EMPTY,EMPTY, WALL, WALL,EMPTY,EMPTY, WALL,EMPTY,EMPTY, WALL, WALL,EMPTY,EMPTY, WALL, EMPTY, EMPTY,EMPTY, WALL,EMPTY,	//20*
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY, EMPTY, EMPTY,EMPTY, WALL,EMPTY,	//21 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY, EMPTY, EMPTY,EMPTY, WALL,EMPTY,	//22 *
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,EMPTY,WALL, WALL,EMPTY,EMPTY, WALL, WALL,EMPTY,EMPTY, WALL,EMPTY,EMPTY, WALL, WALL,EMPTY,EMPTY, WALL, EMPTY, EMPTY,EMPTY, WALL,EMPTY,	//23*
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,EMPTY,WALL, WALL,EMPTY,EMPTY, WALL, WALL,EMPTY,EMPTY, WALL,EMPTY,EMPTY, WALL, WALL,EMPTY,EMPTY, WALL, EMPTY, EMPTY,EMPTY, WALL,EMPTY,	//24*
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY, EMPTY, EMPTY,EMPTY, WALL,EMPTY,	//25*
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY, EMPTY, EMPTY,EMPTY,WALL ,EMPTY,	//26*
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,EMPTY,WALL, WALL,EMPTY,EMPTY, WALL, WALL,EMPTY,EMPTY, WALL,EMPTY,EMPTY, WALL, WALL,EMPTY,EMPTY, WALL, EMPTY, EMPTY,EMPTY, WALL,EMPTY,	//27*
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,EMPTY,WALL, WALL,EMPTY,EMPTY, WALL, WALL,EMPTY,EMPTY, WALL,EMPTY,EMPTY, WALL, WALL,EMPTY,EMPTY, WALL, EMPTY, EMPTY,EMPTY, WALL, EMPTY,	//28*
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY, EMPTY, EMPTY,EMPTY,WALL,EMPTY,	//29*
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY, EMPTY, EMPTY,EMPTY,WALL ,EMPTY,	//30*
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL,EMPTY ,EMPTY,WALL ,WALL ,EMPTY,EMPTY,WALL , EMPTY, EMPTY,EMPTY,WALL ,EMPTY,	//31*
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY, EMPTY, EMPTY,EMPTY,WALL ,EMPTY,	//32*
	EMPTY,WALL ,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY, EMPTY, EMPTY,EMPTY,WALL ,EMPTY,	//33*
	EMPTY,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL , WALL,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,WALL ,EMPTY,	//34*
	EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY, EMPTY, EMPTY,EMPTY,EMPTY,EMPTY,	//35*
	EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY, EMPTY,EMPTY,EMPTY,EMPTY,	//36*
	EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY, EMPTY,EMPTY,EMPTY,	//37*
	};
