...
bool SceneLevel1::Start()
{
	...
	//Top collider
	App->collisions->AddCollider({ 0, 32, 3930, 16 }, Collider::Type::WALL); //ALBA: Esto es la linea azul, orden de valores x y width height
	App->collisions->AddCollider({ 0, 100, 50, 16 }, Collider::Type::WALL);
